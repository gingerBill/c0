...
C0_INSTR(abs_i8,   i8,   i8,      1, "")
C0_INSTR(abs_i16,  i16,  i16,     1, "")
C0_INSTR(abs_i32,  i32,  i32,     1, "")
C0_INSTR(abs_i64,  i64,  i64,     1, "")
C0_INSTR(abs_i128, i128, i128,    1, "")

C0_INSTR(negf_f16,     f16, f16, 1, "")
C0_INSTR(negf_f32,     f32, f32, 1, "")
C0_INSTR(negf_f64,     f64, f64, 1, "")
...
C0_INSTR(min_i8,   i8,   i8,   2, "")
C0_INSTR(min_u8,   u8,   u8,   2, "")
C0_INSTR(min_i16,  i16,  i16,  2, "")
C0_INSTR(min_u16,  u16,  u16,  2, "")
C0_INSTR(min_i32,  i32,  i32,  2, "")
C0_INSTR(min_u32,  u32,  u32,  2, "")
C0_INSTR(min_i64,  i64,  i64,  2, "")
C0_INSTR(min_u64,  u64,  u64,  2, "")
C0_INSTR(min_i128, i128, i128, 2, "")
C0_INSTR(min_u128, u128, u128, 2, "")
C0_INSTR(max_i8,   i8,   i8,   2, "")
C0_INSTR(max_u8,   u8,   u8,   2, "")
C0_INSTR(max_i16,  i16,  i16,  2, "")
C0_INSTR(max_u16,  u16,  u16,  2, "")
C0_INSTR(max_i32,  i32,  i32,  2, "")
C0_INSTR(max_u32,  u32,  u32,  2, "")
C0_INSTR(max_i64,  i64,  i64,  2, "")
C0_INSTR(max_u64,  u64,  u64,  2, "")
C0_INSTR(max_i128, i128, i128, 2, "")
C0_INSTR(max_u128, u128, u128, 2, "")
...
C0_INSTR(atomic_load_f16,   ptr, f16,  1, "")
C0_INSTR(atomic_load_f32,   ptr, f32,  1, "")
C0_INSTR(atomic_load_f64,   ptr, f64,  1, "")
...
C0_INSTR(atomic_store_f16,  f16, void,  2, "")
C0_INSTR(atomic_store_f32,  f32, void,  2, "")
C0_INSTR(atomic_store_f64,  f64, void,  2, "")
...
C0_INSTR(atomic_xchg_f16,  u8, u8, 2, "")
C0_INSTR(atomic_xchg_f32,  u8, u8, 2, "")
C0_INSTR(atomic_xchg_f64,  u8, u8, 2, "")
...
C0_INSTR(atomic_cas_f16,   f16, void, 3, "")
C0_INSTR(atomic_cas_f32,   f32, void, 3, "")
C0_INSTR(atomic_cas_f64,   f64, void, 3, "")
...
C0_INSTR(atomic_addf_f16, f16, f16, 2, "")
C0_INSTR(atomic_addf_f32, f32, f32, 2, "")
C0_INSTR(atomic_addf_f64, f64, f64, 2, "")
...
C0_INSTR(atomic_subf_f16, f16, f16, 2, "")
C0_INSTR(atomic_subf_f32, f32, f32, 2, "")
C0_INSTR(atomic_subf_f64, f64, f64, 2, "")
